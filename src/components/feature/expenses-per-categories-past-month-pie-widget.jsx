...
export default function ExpensesPerCategoriesPastMonthPie() {
  ...
  return (
    <WidgetContainer
      loading={isLoading}
      title="Rashodi po kategorijama prethodnog meseca"
    >
      {data.length ? <PieChart data={data} /> : <div>Nema rashoda</div>}
    </WidgetContainer>
  );
}
